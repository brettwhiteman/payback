                ...
                <div class="card mb-2">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-center">
                            <span class="font-weight-bold" style="font-size: 18px">{{ number_format($transaction->amount, 2) }}</span><br>
                            <span class="font-italic" style="font-size: 12px">{{ $transaction->description }}</span><br>
                            <span style="font-size: 12px">{!! $transaction->created_at->format('j<\s\u\p>S</\s\u\p> F Y') !!}</span>
                        </div>
